...
SPICE_JAR = r'D:\AAAPycharmProject\ImageCaptioning.pytorch\coco-caption\pycocoevalcap\spice\spice-1.0.jar'
TEMP_DIR = 'tmp'
CACHE_DIR = 'cache'
...
class Spice:
    ...
    def compute_score(self, gts, res):
        ...
        spice_cmd = [r"C:\Program Files (x86)\Common Files\Oracle\Java", '-jar', '-Xmx8G', SPICE_JAR, in_file.name,
          '-cache', cache_dir,
          '-out', out_file.name,
          '-subset',
          '-silent'

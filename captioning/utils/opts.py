...
def parse_opt():
    ...
    # feat fusion
    parser.add_argument("--input_att_dir_rsi", type=str, default=None,
                    help="path to the document containing RSI features")
    parser.add_argument("--use_feat_fusion", type=bool, default=False,
                        help="if use feature fusion")
    # text mask
    parser.add_argument("--use_text_mask", type=bool, default=False,
                        help="if use text masking")

    # bert
    parser.add_argument("--bert_premodel", type=str, default=None,
                        help="path to document containing bert config")
    parser.add_argument("--gpt_premodel", type=str, default=None,
                        help="path to document containing gpt config")
    ...
    parser.add_argument('--att_feat_size', type=int, default=2048, # 2048
                    help='2048 for resnet, 512 for vgg')
    # feat fusion
    parser.add_argument('--rsi_feat_size', type=int, default=2048,
                    help='rsi feat')
    ...
    parser.add_argument('--prefix_length', type=int, default=40,
                    help='num of prefix')
    parser.add_argument('--feat_size', type=int, default=196*768,
                    help='the size of the last output of encoder')
    parser.add_argument('--use_learnable_prefix', type=bool, default=True,
                    help='if use learnable prefix')
    parser.add_argument('--use_prefix_feat', type=bool, default=False,
                        help='if use feat as prefix')
    parser.add_argument('--prefix_feat', type=str, default='rsclip',
                        help='rsclip or rn')

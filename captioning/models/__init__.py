...
from .TranformerFeatsFusion_prefix_Bert import CLIPFeatsFusionPrefixBERT  # use "clipffprefixbert" to denote our method in "caption_model" option
...
def setup(opt):
    ...
    # CLIP Feats Fusion
    elif opt.caption_model == "clipffprefixbert":
        model = CLIPFeatsFusionPrefixBERT(opt)
